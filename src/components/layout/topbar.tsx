...
import { Menu, Bell, Search, User as UserIcon, LogOut, Settings } from 'lucide-react';
    ...
    <header className="h-16 border-b border-[#E5E7EB] bg-white sticky top-0 z-40">
      <div className="h-full px-4 md:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Button variant="ghost" size="icon" className="relative text-[#6B7280] hover:text-[#111827]">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="p-1 h-auto flex items-center space-x-3">
                ...
                <Avatar className="h-9 w-9 border border-[#E5E7EB]">
                  ...
                  <AvatarFallback className="bg-[#F1F3F5] text-[#111827]">
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => logout()} className="text-[#DC2626] cursor-pointer">
