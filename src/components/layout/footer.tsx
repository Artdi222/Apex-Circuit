    ...
    <footer className="bg-white border-t border-gray-100 pt-20 pb-10 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-6 uppercase tracking-wider text-[10px]">Platform</h4>
            <ul className="space-y-4">
              {[
                ...
                <li key={link.name}>
                  <Link href={link.href} className="text-gray-500 hover:text-blue-600 transition-colors text-sm font-medium">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-6 uppercase tracking-wider text-[10px]">Support</h4>
            <ul className="space-y-4">
              {[
                { name: 'Contact', href: '#' },
                { name: 'FAQ', href: '#' },
